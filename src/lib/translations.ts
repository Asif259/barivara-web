export const translations = {
  bn: {
    ...
    loginNow: 'লগইন করুন',
    security: 'সুরক্ষা',
    securitySub: 'আপনার পাসওয়ার্ড নিরাপদভাবে আপডেট করুন',
    securitySettingsTitle: 'পাসওয়ার্ড ও নিরাপত্তা',
    securitySettingsDesc: 'আপনার অ্যাকাউন্টের নিরাপত্তা নিশ্চিত করতে নিয়মিত শক্তিশালী পাসওয়ার্ড ব্যবহার করুন।',
    currentPassword: 'বর্তমান পাসওয়ার্ড',
    newPassword: 'নতুন পাসওয়ার্ড',
    confirmNewPassword: 'নতুন পাসওয়ার্ড নিশ্চিত করুন',
    passwordChangedSuccess: 'পাসওয়ার্ড সফলভাবে পরিবর্তন হয়েছে',
    changingPassword: 'পাসওয়ার্ড পরিবর্তন হচ্ছে...',
    changePassword: 'পাসওয়ার্ড পরিবর্তন করুন',
    forgotPasswordTitle: 'পাসওয়ার্ড ভুলে গেছেন?',
    forgotPasswordSub: 'পাসওয়ার্ড পুনরুদ্ধারের জন্য নিচের যেকোনো একটি মাধ্যম বেছে নিন',
    forgotPasswordOptionA: 'আমার বর্তমান পাসওয়ার্ড জানা আছে',
    forgotPasswordOptionASub: 'বর্তমান পাসওয়ার্ড যাচাই করে সরাসরি নতুন পাসওয়ার্ড সেট করুন',
    forgotPasswordOptionB: 'আমার ইমেইলে ওটিপি কোড পাঠান',
    forgotPasswordOptionBSub: 'ইমেইলে পাঠানো ৬ ডিজিটের ওটিপি যাচাই করে নতুন পাসওয়ার্ড দিন',
    sendOtp: 'ওটিপি পাঠান',
    sendingOtp: 'ওটিপি পাঠানো হচ্ছে...',
    verifyOtp: 'ওটিপি যাচাই করুন',
    verifyingOtp: 'যাচাই করা হচ্ছে...',
    otpSentSuccess: 'পাসওয়ার্ড রিসেট ওটিপি আপনার ইমেইলে পাঠানো হয়েছে',
    otpVerifiedSuccess: 'ওটিপি সফলভাবে যাচাই হয়েছে। এবার নতুন পাসওয়ার্ড দিন।',
    resendOtp: 'পুনরায় ওটিপি পাঠান',
    passwordComplexityHint: 'পাসওয়ার্ড কমপক্ষে ৮ অক্ষরের এবং বড় ও ছোট হাতের অক্ষর, সংখ্যা বা বিশেষ চিহ্ন থাকতে হবে',
    passwordMismatch: 'নতুন পাসওয়ার্ড এবং নিশ্চিতকরণ পাসওয়ার্ড মিলছে না',
    passwordSameAsOld: 'নতুন পাসওয়ার্ড বর্তমান পাসওয়ার্ডের সমান হতে পারবে না',
    resetPasswordTitle: 'পাসওয়ার্ড রিসেট করুন',
    resetPasswordSub: 'ইমেইল ও ওটিপি ব্যবহার করে নতুন পাসওয়ার্ড সেট করুন',
    otpLabel: 'ওটিপি কোড',
    otpPlaceholder: '৬ ডিজিটের কোড লিখুন',
    passwordResetSuccess: 'পাসওয়ার্ড সফলভাবে রিসেট হয়েছে',
    resettingPassword: 'পাসওয়ার্ড রিসেট হচ্ছে...',
    resetPasswordBtn: 'পাসওয়ার্ড রিসেট করুন',
    backToLogin: 'লগইন পৃষ্ঠায় ফিরে যান',
    ...
    editTenant: 'ভাড়াটিয়া এডিট করুন',
    noTenantsFound: 'কোনো ভাড়াটিয়া পাওয়া যায়নি',
    personalContact: 'ব্যক্তিগত ও যোগাযোগ',
    emergencyContactSection: 'জরুরি যোগাযোগ',
    documents: 'ডকুমেন্ট',
    profilePicture: 'প্রোফাইল ছবি',
    nidFront: 'এনআইডি — সামনের পাশ',
    nidBack: 'এনআইডি — পেছনের পাশ',
    imagePreview: 'ছবি প্রিভিউ',
    imageLoadError: 'ছবি লোড করা যায়নি',
    noImageAvailable: 'কোনো ছবি নেই',

    // Agreements
    addNewAgreement: 'নতুন ভাড়া চুক্তি করুন',
    editAgreement: 'ভাড়া চুক্তি এডিট করুন',
  ...
  en: {
    ...
    loginNow: 'Login Now',
    security: 'Security',
    securitySub: 'Keep your password secure and up to date',
    securitySettingsTitle: 'Security & Password',
    securitySettingsDesc: 'Keep your account secure by maintaining a strong, unique password.',
    ...
    forgotPasswordSub: 'Choose your preferred method to recover your account',
    forgotPasswordOptionA: 'I know my current password',
    forgotPasswordOptionASub: 'Verify your current password and set a new password directly',
    forgotPasswordOptionB: 'Send OTP to my registered email',
    forgotPasswordOptionBSub: 'Verify a 6-digit OTP code sent to your registered email address',
    sendOtp: 'Send OTP',
    sendingOtp: 'Sending OTP...',
    verifyOtp: 'Verify OTP',
    verifyingOtp: 'Verifying OTP...',
    otpSentSuccess: 'Password reset OTP has been sent to your email',
    otpVerifiedSuccess: 'OTP verified successfully. Please enter your new password.',
    resendOtp: 'Resend OTP',
    passwordComplexityHint: 'Password must be at least 8 characters with uppercase, lowercase, and numbers/symbols',
    ...
    resetPasswordSub: 'Verify your email and OTP to set a new password',
    otpLabel: 'OTP Code',
    ...
    editAgreement: 'Edit Rental Agreement',
